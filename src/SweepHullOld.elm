...
unwrapAdjacencyList : String -> Result x AdjacencyList -> AdjacencyList
unwrapAdjacencyList location alist =
    case alist of
        Err e ->
            Debug.crash <| "invalid adjacency list at " ++ location ++ " with error " ++ toString e
